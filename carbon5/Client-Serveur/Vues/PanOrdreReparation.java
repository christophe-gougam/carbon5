...
public class PanOrdreReparation extends JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nombre de jours dans le d�p�t");
        ...
        jLabel4.setText("Indiff�rence");

        jLabel5.setText("V�to");

        jLabel7.setText("Temps de r�paration");
...
class BoutonListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent arg0){
		...
		logger.info("Enregistrement des pr�f�rences de priorisation");
